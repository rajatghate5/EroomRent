    ...
    <footer style={{ marginTop: "3rem" }}>
        ...
        <div className="col-sm-12">
          ...
          <div className="row">
            <div
              ...
              style={{ gap: "1rem" }}
            >
              <Link to="/broker/rentalagreement" className="btn btn-secondary">
                Rental Agreement
              </Link>
              <Link to="/broker/privacypolicy" className="btn btn-secondary">
      ...
      <div className="row border-top border-bottom border-secondary py-5 bg-lightest-grey">
        ...
        <div className="col-sm-6 text-center">
          ...
          <Link to="/broker" className="btn btn-dark">
            Post Now
          </Link>
        </div>
      </div>
        ...
        <div className="col-sm-8 text-center">
          ...
          <div className="row ">
            <div className="col-sm-12 d-sm-flex justify-content-center align-items-center border-bottom py-4 px-0 mx-0 border-bottom border-secondary">
              ...
              <Link
                to="/broker/termsandconditions"
                className="mx-3 text-secondary fos-20"
              >
                Terms & Conditions
              </Link>
              <Link
                to="/broker/privacypolicy"
                className="mx-3 text-secondary fos-20"
              >
                Privacy Policy
              </Link>
              <Link
                to="/broker/testimonial"
                className="mx-3 text-secondary fos-20"
              >
                Testimonials
              </Link>
              <Link to="/broker/sitemap" className="mx-3 text-secondary fos-20">
                Sitemap
              </Link>
              <Link
                href="/broker/faq"
