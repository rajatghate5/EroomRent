    ...
    <footer style={{ marginTop: "3rem" }}>
        ...
        <div className="col-sm-12">
          ...
          <div className="row">
            <div
              ...
              style={{ gap: "1rem" }}
            >
              <Link to="/tenant/rentalagreement" className="btn btn-secondary">
                Rental Agreement
              </Link>
              <Link to="/tenant/privacypolicy" className="btn btn-secondary">
      ...
      <div className="row border-top border-bottom border-secondary py-5 bg-lightest-grey">
        <div className="col-sm-6 text-center border-right border-secondary">
          ...
          <Link to="/tenant" className="btn btn-dark">
            Find Now
          </Link>
        </div>
        ...
        <div className="col-sm-8 text-center">
          ...
          <div className="row ">
            <div className="col-sm-12 d-sm-flex justify-content-center align-items-center border-bottom py-4 px-0 mx-0 border-bottom border-secondary">
              <Link
                to="/tenant/faq"
                className="px-0 mx-0 text-secondary fos-20"
              >
                About Us
              </Link>
              <Link
                to="/tenant/termsandconditions"
                className="mx-3 text-secondary fos-20"
              >
                Terms & Conditions
              </Link>
              <Link
                to="/tenant/privacypolicy"
                className="mx-3 text-secondary fos-20"
              >
                Privacy Policy
              </Link>
              <Link
                to="/tenant/testimonial"
                className="mx-3 text-secondary fos-20"
              >
                Testimonials
              </Link>
              <Link to="/tenant/sitemap" className="mx-3 text-secondary fos-20">
                Sitemap
              </Link>
              <Link
                href="/tenant/faq"
