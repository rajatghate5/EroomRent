    ...
    <footer style={{ marginTop: "3rem" }}>
        ...
        <div className="col-sm-12">
          ...
          <div className="row">
            <div
              ...
              style={{ gap: "1rem" }}
            >
              <Link to="/admin/rentalagreement" className="btn btn-secondary">
                Rental Agreement
              </Link>
              <Link to="/admin/privacypolicy" className="btn btn-secondary">
      ...
      <div className="row border-top border-bottom border-secondary py-5 bg-lightest-grey">
        ...
        <div className="col-sm-6 text-center">
          ...
          <Link to="/admin/postyourproperty" className="btn btn-dark">
            Post Now
          </Link>
        </div>
      </div>
        ...
        <div className="col-sm-8 text-center">
          ...
          <div className="row ">
            <div className="col-sm-12 d-sm-flex justify-content-center align-items-center border-bottom py-4 px-0 mx-0 border-bottom border-secondary">
              ...
              <Link to="/admin/sitemap" className="mx-3 text-secondary fos-20">
                Sitemap
              </Link>
              <Link
                href="/admin/faq"
